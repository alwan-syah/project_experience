...
if (isset($_GET['act'])) {
    ...
    if ($_GET['act'] == 'insert') {
        ...
        if ($username == '' || $_POST['password'] == '' || $namalengkap == '') {
            //header('location:data_admin.php?vide=tambah;);
        ...
        if ($username == '' || $namalengkap == '') {
            ...
            if ($_POST['password'] == '') {
                ...
                namalengkap='$namalengkap' WHERE idadmin='$idadmin'");
            } else {
                $update = mysqli_query($konek, "UPDATE admin SET username='$username',
                password='$password', namalengkap='$namalengkap' WHERE idadmin='$idadmin'");
            }
            if ($update) {
                header('location:data_admin.php?e=sukses');
            } else {
