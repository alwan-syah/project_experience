...
<div class="container">
    ...
    switch ($view) {
        default:
            ...
            //untul pesan berhasil atau gagal proses
    ...
    ?>
            ...
            ?>
                <div class="alert alert-danger alert-dismissible" role="alert">
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <strong>Eror!</strong> Proses Gagal.
                </div>
            <?php
            }
            ?>
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" method="POST" action="aksi_admin.php?act=update">
                        ...
                        <div class="form-group">
                            <label class="col-md-2">Password</label>
                            <div class="col-md-4">
                                <input type="password" name="password" class="form-control" placeholder="Kosongkan Jika Tidak Diganti" required>
                            </div>
                        </div>
